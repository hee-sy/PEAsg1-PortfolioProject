...
<body class="flex flex-col bg-slate-50">
	...
	<div
		class="justify-center items-center self-center z-[1] flex w-[400px] max-w-full flex-col mt-20 px-5 py-0.5 max-md:mt-10">
		<div class="items-stretch self-stretch flex flex-col -mr-5">
			<div
				class="text-zinc-800 self-center text-2xl font-nunito font-semibold leading-6 whitespace-nowrap">
		...
		<div class="items-stretch self-stretch flex flex-col -mr-5 mt-7">
			<div
				...
				Message:</div>
			<div
				class="border bg-white shrink-0 flex flex-col mt-3 rounded-lg border-solid border-slate-200 max-w-[your-value] overflow-hidden">
				<div
					class="text-justify whitespace-normal p-4 overflow-hidden overflow-wrap-break-word word-wrap-break-word break-words">
					${param.message}</div>
			</div>
		</div>
	</div>
